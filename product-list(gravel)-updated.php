...
<head>
    ...
    <link rel="stylesheet" href="product-list(gravel)-updated.css">
    ...
    <main>
        <div class="container">
                <div class="products">
                    ...
                    <div class="">
                        <div class="con-items">
                            <button class="con-btn">ALL</button>
                            <button class="con-btn">GRAVEL</button>
                            <button class="con-btn">CEMENT</button>
                            <button class="con-btn">PIPES</button>
                            <button class="con-btn">PAINT</button>
                            <button class="con-btn">PLYBOARD</button>
                            <button class="con-btn">CINDERBLOCK</button>
                        </div>
                        <p>Showing GRAVEL Products</p>
                    </div>
                    <div class="product-details">
                        ...
                        <div class="card">
                            ...
                            <p>GRAVEL</p>
                            <div class="title">
                                <h2>RIVER JACK GRAVEL 3/4"(1cbm)</h2>
                                <p>₱1,050.00</p>
                                <button class="cart-btn">Add to cart <i class="fa-solid fa-basket-shopping"></i></button>
                                <button class="view-btn">View details  <i class="fa-solid fa-circle-info"></i></button>
                            </div>
